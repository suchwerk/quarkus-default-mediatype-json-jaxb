# quarkus-default-mediatype-json-jaxb Project
...
You can then execute your native executable with: `./target/quarkus-default-mediatype-json-jaxb-1.0.0-SNAPSHOT-runner`
